        ...
        <div class="col9">
            ...
            <div class="boxed">
              <div class="long">
                ...
                <div class="col33 courseItem">
                   <div class="courseImg" style="background: url('img/fm.jpg');"><i class="material-icons">visibility</i></div>
                   <div class="text">
                        <a href="course"><h5 class="blue">Financial Markets</h5></a>
                        <p>
                          An overview of the ideas, methods and institutions that permit human societies to manage risks and foster enterprise.
                          <br><br>
                          <i>Due Date: </i> <b>21 Feb, 18</b>
                        </p>
