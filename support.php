...
<title>LMS | Support Center</title>
    ...
    <style>
        ...
        .pageTab:nth-child(1):hover {
           border: 2px solid #666 !important;
        }
        .pageTab:nth-child(1):hover .tabing {
            background: #961c1d !important;
        }
          
        .pageTab:nth-child(7n-6) {
           border: 2px solid #666;
        }
        .pageTab:nth-child(7n-6) .tabing {
            background: #961c1d;
        }
...
<div class="content">
	<div class="col9">
			...
			<div class="bigHead">Frequently Asked Questions</div>
